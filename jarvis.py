...
from AppOpener import close as close3
from AppOpener import close as close4
from AppOpener import close as close5
from AppOpener import close as close6
from AppOpener import close as close7
from AppOpener import close as close8
from AppOpener import close as close9
from AppOpener import close as close10
...
if __name__ == "__main__":
    ...
    if 1:
        ...
        # print("there you go sir your chatting applications are open ")
            ...
            print(
                "sure sir but your friends might not be online sir if you insist i weill surly check it for you" or "sure sir but your friends might not be online sir but master saksham to make sure i will check it ")
        ...
        elif "i want to see system file" in query:
            ...
            speak("closing your browser" )
            close3("Microsoft Edge",match_closest=True)

            print("closing your browser")

        elif "cut off communication" in query:
            speak("closing all unnecessary communication programs ")
            close4("discord" , match_closest=True)
            close5("whatsapp",match_closest=True)
            print("closing all unnecessary communication programs ")
        elif "open youtube" in query:
            webbrowser.open("youtube.com")
            speak("here is youtube sir as you commanded")
            print("Here is youtube sir as you commanded")

        elif "jarvis stop playing music " in query:
            close6("spotify")
            speak("ok sir closing spotify ")
            print("Ok sir ")

        elif "minimise all applications" in query:
            speak("minimising all application ")
...
print("This code is made by saksham")
print("_________________")
